...
def fetch_nfl_draft_stats():
    url = "https://www.pro-football-reference.com/draft/2025-combine.htm"
    ...
    stats = get_table_by_id("combine")

    return stats

if __name__ == "__main__":
    stats = fetch_nfl_draft_stats()

    print("=== Players ===")
    print(stats.head())

    # Optional: Save to CSV
    stats.to_csv("2025_nfl_combine_results.csv", index=False)
